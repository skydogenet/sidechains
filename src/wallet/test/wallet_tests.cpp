...
BOOST_FIXTURE_TEST_CASE(rescan, Thunder100Setup)
{
    ...
    // after.
    {
        ...
        BOOST_CHECK_EQUAL(response.write(),
            strprintf("[{\"success\":false,\"error\":{\"code\":-1,\"message\":\"Rescan failed for key with creation "
                      ...
                      "by pruning or data corruption (see thunderd log for details) and could be dealt with by "
...
BOOST_FIXTURE_TEST_CASE(importwallet_rescan, Thunder100Setup)
{
    // TODO Make this test work without block subsidy
    /*
...
// debit functions.
BOOST_FIXTURE_TEST_CASE(coin_mark_dirty_immature_credit, Thunder100Setup)
{
    // TODO Make this test work without block subsidy
    /*
    CWallet wallet;
...
class ListCoinsTestingSetup : public Thunder100Setup
{
public:
