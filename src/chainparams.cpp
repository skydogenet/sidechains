...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1647553817, 1, 0);
        consensus.hashGenesisBlock = genesis.GetHash();

        assert(consensus.hashGenesisBlock == uint256S("0x2a0637183ef985057576b94bab8ad5c65c8f68a75b0990828b688f184c75ec14"));
