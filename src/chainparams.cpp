...
public:
    CMainParams() {
        ...
        consensus.defaultAssumeValid = uint256S("0x266cab5f55847f2e188f7facddbfc564aa9dd2f6cd471ac0a7439df34c9db3e5");
        ...
        genesis = CreateGenesisBlock(1662178505, 1, 0);
        consensus.hashGenesisBlock = genesis.GetHash();

        assert(consensus.hashGenesisBlock == uint256S("0x266cab5f55847f2e188f7facddbfc564aa9dd2f6cd471ac0a7439df34c9db3e5"));
        ...
        checkpointData = {
            {
                { 0, uint256S("0x266cab5f55847f2e188f7facddbfc564aa9dd2f6cd471ac0a7439df34c9db3e5")},
            }
        };
