...
/** Find the best known BMM block and make it the chain tip */
bool ActivateBestBMMChain(CValidationState& state, const CChainParams& chainparams, std::shared_ptr<const CBlock> pblock = std::shared_ptr<const CBlock>());
