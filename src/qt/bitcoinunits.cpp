...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Side coins");
    case mBTC: return QString("Milli-Side coins (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-Side coins (bits) (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    default: return QString("???");
    }
}
