...
# TestNode: A peer we use to send messages to testchainplusd, and store responses.
...
class CompactBlocksTest(BitcoinTestFramework):
    ...
    # This test actually causes testchainplusd to (reasonably!) disconnect us, so do this last.
    ...
    # testchainplusd's choice of nonce.
    ...
    # Test that testchainplusd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for testchainplusd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # testchainplusd will not send blocktxn responses for blocks whose height is
