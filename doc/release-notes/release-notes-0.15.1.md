...
or `thunderd`/`bitcoin-qt` (on Linux).
...
- #10798 `716066d` test thunder-cli (jnewbery)
...
- #11125 `812c870` Add thunder-cli -stdin and -stdinrpcpass functional tests (promag)
...
### Miscellaneous
- #11377 `75997c3` Disallow uncompressed pubkeys in thunder-tx [multisig] output adds (TheBlueMatt)
