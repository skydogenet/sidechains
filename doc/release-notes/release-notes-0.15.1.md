...
or `sidechaind`/`bitcoin-qt` (on Linux).
...
- #10798 `716066d` test sidechain-cli (jnewbery)
...
- #11125 `812c870` Add sidechain-cli -stdin and -stdinrpcpass functional tests (promag)
...
### Miscellaneous
- #11377 `75997c3` Disallow uncompressed pubkeys in sidechain-tx [multisig] output adds (TheBlueMatt)
