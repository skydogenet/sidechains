...
or `testchaind`/`bitcoin-qt` (on Linux).
...
- #10798 `716066d` test testchain-cli (jnewbery)
...
- #11125 `812c870` Add testchain-cli -stdin and -stdinrpcpass functional tests (promag)
...
### Miscellaneous
- #11377 `75997c3` Disallow uncompressed pubkeys in testchain-tx [multisig] output adds (TheBlueMatt)
