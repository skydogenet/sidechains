...
or `trainchaind`/`bitcoin-qt` (on Linux).
...
- #10798 `716066d` test trainchain-cli (jnewbery)
...
- #11125 `812c870` Add trainchain-cli -stdin and -stdinrpcpass functional tests (promag)
...
### Miscellaneous
- #11377 `75997c3` Disallow uncompressed pubkeys in trainchain-tx [multisig] output adds (TheBlueMatt)
