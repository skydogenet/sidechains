...
or `testchainplusd`/`bitcoin-qt` (on Linux).
...
- #10798 `716066d` test testchainplus-cli (jnewbery)
...
- #11125 `812c870` Add testchainplus-cli -stdin and -stdinrpcpass functional tests (promag)
...
### Miscellaneous
- #11377 `75997c3` Disallow uncompressed pubkeys in testchainplus-tx [multisig] output adds (TheBlueMatt)
