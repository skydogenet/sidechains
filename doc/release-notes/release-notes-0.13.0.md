...
sidechain-cli: arguments privacy
------------------------------
...
For example:
    ...
    $ src/sidechain-cli -stdin walletpassphrase
    mysecretcode
    120
...
- #7550 `8b958ab` Input-from-stdin mode for sidechain-cli (laanwj)
...
- #8257 `ff03c50` Do not ask a UI question from sidechaind (sipa)
...
- #8047 `37f9a1f` Test_framework: Set wait-timeout for sidechaind procs (MarcoFalke)
...
- #7744 `d8e862a` test_framework: detect failure of sidechaind startup (laanwj)
