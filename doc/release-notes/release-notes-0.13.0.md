...
testchain-cli: arguments privacy
------------------------------
...
For example:
    ...
    $ src/testchain-cli -stdin walletpassphrase
    mysecretcode
    120
...
- #7550 `8b958ab` Input-from-stdin mode for testchain-cli (laanwj)
...
- #8257 `ff03c50` Do not ask a UI question from testchaind (sipa)
...
- #8047 `37f9a1f` Test_framework: Set wait-timeout for testchaind procs (MarcoFalke)
...
- #7744 `d8e862a` test_framework: detect failure of testchaind startup (laanwj)
