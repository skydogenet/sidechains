...
- #8829 `2a8bca4` Add thunder-tx JSON tests (jnewbery)
...
- #8860 `0bee740` util: Move wait_thunderds() into stop_nodes() (MarcoFalke)
...
- #8817 `bcf3806` update thunder-tx to output witness data (jnewbery)
