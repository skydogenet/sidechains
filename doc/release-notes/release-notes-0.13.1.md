...
- #8829 `2a8bca4` Add trainchain-tx JSON tests (jnewbery)
...
- #8860 `0bee740` util: Move wait_trainchainds() into stop_nodes() (MarcoFalke)
...
- #8817 `bcf3806` update trainchain-tx to output witness data (jnewbery)
