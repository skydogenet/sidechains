...
- #8829 `2a8bca4` Add sidechain-tx JSON tests (jnewbery)
...
- #8860 `0bee740` util: Move wait_sidechainds() into stop_nodes() (MarcoFalke)
...
- #8817 `bcf3806` update sidechain-tx to output witness data (jnewbery)
