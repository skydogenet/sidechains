...
* bitcoin.conf: contains configuration settings for thunderd or bitcoin-qt
* thunderd.pid: stores the process id of thunderd while running
...
* debug.log: contains debug information and general logging generated by thunderd or bitcoin-qt
