...
* bitcoin.conf: contains configuration settings for sidechaind or bitcoin-qt
* sidechaind.pid: stores the process id of sidechaind while running
...
* debug.log: contains debug information and general logging generated by sidechaind or bitcoin-qt
