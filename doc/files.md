...
* bitcoin.conf: contains configuration settings for testchaind or bitcoin-qt
* testchaind.pid: stores the process id of testchaind while running
...
* debug.log: contains debug information and general logging generated by testchaind or bitcoin-qt
